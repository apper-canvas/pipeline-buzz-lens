...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      createRoute({
        path: "companies",
        element: <MainLayout><Companies /></MainLayout>,
      }),
      createRoute({
        path: "pipeline",
        element: <MainLayout><Pipeline /></MainLayout>,
      }),
      createRoute({
        path: "deals",
        element: <MainLayout><Deals /></MainLayout>,
      }),
      createRoute({
        path: "quotes",
      ...
      createRoute({
        path: "sales-orders",
        element: <MainLayout><SalesOrders /></MainLayout>,
      }),
      createRoute({
        path: "activities",
